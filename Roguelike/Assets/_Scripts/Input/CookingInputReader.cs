...
public class CookingInputReader : BaseInputReader
{
    ...
    public Action<int> OnIngredient1Triggered;
    public Action<int> OnIngredient2Triggered;
    public Action<int> OnIngredient3Triggered;
    public Action<int> OnIngredient4Triggered;
    public Action<int> OnIngredient5Triggered;
    public Action<int> OnIngredient6Triggered;
    ...
    {
        _ingredient1ActionDelegate = _ => OnIngredient1Triggered?.Invoke(0);
        _ingredient1Action.performed += _ingredient1ActionDelegate;

        _ingredient2ActionDelegate = _ => OnIngredient2Triggered?.Invoke(1);
        _ingredient2Action.performed += _ingredient2ActionDelegate;

        _ingredient3ActionDelegate = _ => OnIngredient3Triggered?.Invoke(2);
        _ingredient3Action.performed += _ingredient3ActionDelegate;

        _ingredient4ActionDelegate = _ => OnIngredient4Triggered?.Invoke(3);
        _ingredient4Action.performed += _ingredient4ActionDelegate;

        _ingredient5ActionDelegate = _ => OnIngredient5Triggered?.Invoke(4);
        _ingredient5Action.performed += _ingredient5ActionDelegate;

        _ingredient6ActionDelegate = _ => OnIngredient6Triggered?.Invoke(5);
